...
<!--</style>-->
<div style="margin-top: 5em!important;margin-left:15.5em">
    <p style="position: static!important; width: 30%!important;padding: 2px!important; font-size: 18px;margin-left:15em;"
       class="linea">
...
<table style="height: 150px; width: 750px;">
    ...
    <tr style="height: 5px;">
        <td style="width: 100px; height: 20px;" colspan="2">
            <b> <?php
                $n = $datos_generales_pago["pago"] * $dolar;
                $numero_conver = floor($n);
                $fraction = ($n - $numero_conver) * 100;
                if ($fraction == 0) {
                    echo convertir($numero_conver) . " CÓRDOBAS NETO";
                } else {
                    echo convertir($numero_conver) . " CÓRDOBAS CON " . number_format(($fraction), 0, '.', ',') . "/100";
                }
    ...
    <tr style="height: 5px; margin-top: 0.5em;">
...
<p style="width: 10px; font-size: 18px" style="margin-left: 37em!important;">
    <b>C$ <?php echo number_format(($datos_generales_pago["pago"] * $dolar), 2, '.', ',');; ?></b>
</p>
<p></p>
<p></p>
<p></p>
