...
function numeros_faltantes_en_rango($A, $B, $numeros_presentes, $indsucursal, $mysqli)
{
    ...
    $max_iterations = 100;  // Set a maximum iteration limit
    ...
    for ($num = $A; $num <= $B; $num++) {
        ...
        // Check for maximum iterations and exit the loop
        if ($num - $A + 1 >= $max_iterations) {
            ...
            <section class="row">
                ...
                <div class="control-pares col-md-2">
                    <input type="number" name="textfactura" class="form-control input_modificado"
                           placeholder="No Factura" autofocus value="">
                </div>
        ...
        if ($indsucursal == "2" or $indsucursal == "3" or $indsucursal == "4" or $indsucursal == "5" or $indsucursal == "6" or $indsucursal == "7") {
            ...
            <div class="row" style="margin: 0;padding: 0;">
                <p class="alert alert-primary center-block">
                    ...
                    <!--                        <span-->
                    <!--                                style="margin-left:1em ;">Sub_Total Ventas: C$-->
                    <!--                        --><?php //echo number_format($datos_hoy_con["sub"], 2, '.', ',');
                    ?><!--</span><span-->
                    <!--                                style="margin-left:1em ;">Total Venta: C$-->
                    <!--                        --><?php //echo number_format($datos_hoy_con["total"], 2, '.', ',');;
                    ?><!--</span>-->
                </p>
            </div>
        <?php } ?>
...
<hr>
<div class="z-depth-1 rounded white center-block" style="width: 97%;border-radius: 6px;padding: 1em;">
        ...
        while ($resultado = $result4->fetch_assoc()) {
            ...
            <?php if ($resultado['bandera'] == "1") { ?>
                <tr>
                    ...
                    <td class="center-align alert-danger"><?php echo number_format($resultado["total"], 2, '.', ','); ?></td>
                    <td class="center-align alert alert-dark">
                    ...
                    <?php
                    if (datos_clientes::fecha_get_pc_MYSQL_form() == $resultado["fecha"]) { ?>
                        <td><a href="#" onclick="
                    ...
                    <?php } else { ?>
                        <td><a href="#"
                               class="btn btn-danger">Denegado</a></td>
                        <td><a href="#"
                               class="btn btn-danger">Denegado</a></td>
                    <?php } ?>
