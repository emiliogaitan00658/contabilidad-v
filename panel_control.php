...
<br>
<div class="container">
    <h5 class="alert alert-primary">Modulo de inventario</h5>
    <hr>
    <div class="row">
        <div class="col-sm-3">
            <div class="card">
                <div class="card-body center-align">
                    <h5 class="card-title">Agregar producto en stok</h5>
                    <p class="card-text">Este modulo podemos agregar datos inventario.</p>
                    <a href="inventario_general/ingreso_stock.php" class="btn btn-secondary">Ir</a>
                </div>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="card">
                <div class="card-body center-align">
                    <h5 class="card-title">Dar de Baja stock</h5>
                    <p class="card-text">Este modulo debe dar de bajar todo el inventario buscar producto.</p>
                    <a href="inventario_general/salida_stock.php" class="btn btn-secondary">ir</a>
                </div>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="card">
                <div class="card-body center-align">
                    <h5 class="card-title">Total en stok sucursal Altamira</h5>
                    <p class="card-text">Datos generales de productor de inventario.</p>
                    <a href="inventario_general/productos_generar.php" class="btn btn-secondary">ir</a>
                </div>
            </div>
        </div>
    </div>
