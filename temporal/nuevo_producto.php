...
if ($_POST) {
    ...
    if ($re == "0") {
        datos_clientes::agregar_dato_producto($codigo, $producto, $precio1, $precio2, $precio3,$codigobarra, $mysqli);
        echo '<script> swal({
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>"
            ...
            <section class="row">
                ...
                <div class="control-pares col-md-2">
                    ...
                    <input type="text" name="textbarra" class="form-control" placeholder="$"
                           value="<?php if ($_POST){ $_POST["textbarra"];}else{ echo "0";}?>" >
                </div>
                <br>
                <br>
                <br>
