...
if ($indsucursal == "2" or $indsucursal == "1" or $indsucursal == "24" or $indsucursal == "3" or $indsucursal == "4" or $indsucursal == "5" or $indsucursal == "6" or $indsucursal == "7" or $indsucursal == "8" or $indsucursal == "9") {
    ...
    if ($_POST) {
        ...
        $respuesta_server_credito=datos_clientes::idcliente_credito($key,$mysqli);
        ini_set('display_errors', 1);
        ini_set('display_startup_errors', 1);
        error_reporting(E_ALL);
        if ($respuesta_server_credito=!"false"){

        }else{
            datos_clientes::credito_ind_tempora_cambio($key,$Confirmacion,$mysqli);
        }
