    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" name="myapp"
        ...
        <div class="container z-depth-1 rounded white center-block" style="border-radius: 8px">
            ...
            <div class="modal-footer">
                ...
                <a class="btn white-text red btn-primary" href="crear_factura.php"><i
                            class="icon-redo"> </i> Regresar</a>
                ...
                while ($resultado = $result4->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td style="width:20px;"><input type="text" class="form-control"
                                                       ...
                                                       name="textcantidad<?php echo $contador; ?>" readonly
...
<!--                </div>-->
                ...
                <div class="control-pares col-md-3" style="padding-top: 2em;">
                    <input type="submit" value="" class="btn white-text btn-large btn-dark"/>
                </div>
            </section>
            <br>
        </div>
